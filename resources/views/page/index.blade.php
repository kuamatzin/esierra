...
<html lang="en">
    <head>
        ...
        <title>Entrada a la Sierra</title>
        ...
        <nav class="navbar navbar-inverse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="rooms-single.html">Single Room</a></li>
                            </ul>
                        </li>
            ...
            <div id="mega-slider" class="carousel slide " data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="item active beactive">
                        <img src="images/cabañas/slider1.png" alt="Entrada a la Sierra">
                    ...
                    <div class="item">
                        <img src="images/cabañas/slider2.png" alt="...">
                        <div class="carousel-caption">
                            <img src="images/stars.png" alt="">
                    ...
                    <div class="item">
                        <img src="images/cabañas/slider3.png" alt="...">
                        <div class="carousel-caption">
                            <img src="images/stars.png" alt="">
            ...
            <div class="mg-book-now" id="app">
                <div class="container">
                    <div class="row">
                        <div class="col-md-3">
                            <h2 class="mg-bn-title" style="color: #8D3C44">Reserva <span class="mg-bn-big" style="color:#8D3C44">Checa disponibilidad</span></h2>
                        </div>
                        <div class="col-md-9">
            ...
            <div class="col-md-7">
                ...
                <div class="mg-gallery-container">
                    <ul class="mg-gallery" id="mg-gallery">
                        <li><img src="images/cabañas/galeria/1.jpg" alt="Partner Logo" class="img-responsive"></li>
                        <li><img src="images/cabañas/galeria/2.jpg" alt="Partner Logo" class="img-responsive"></li>
                        <li><img src="images/cabañas/galeria/5.jpg" alt="Partner Logo"></li>
                        <li><img src="images/cabañas/galeria/6.jpg" alt="Partner Logo"></li>
                        <li><img src="images/cabañas/galeria/7.jpg" alt="Partner Logo"></li>
                        <li><img src="images/cabañas/galeria/8.jpg" alt="Partner Logo"></li>
                    </ul>
            ...
            <div class="row">
                <div class="col-md-6 col-sm-6 col-md-offset-3 col-sm-offset-3">
                    <div class="widget">
                        ...
                        <address>
                            <strong>Entrada a la Sierra</strong><br>
                            Camino Viejo a Calcahualco s/n<br>
                            Colonia Los Manzanos, Zacapoaxtla, Puebla.
                        </address>
                        ...
                        <p>
                            <a href="mailto:#">contacto@entradaalasierra.com</a>
                        </p>
                    </div>
                </div>
            </div>
